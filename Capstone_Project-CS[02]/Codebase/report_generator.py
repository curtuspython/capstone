...
def _write_txt_report(
    ...
    lines += [
        ...
        "SCORING METHODOLOGY",
        thin,
        "This report uses two Large Language Models via the Groq API:",
        "  LLM #1 (llama-3.3-70b-versatile) — Analyses the job description and",
        "           extracts structured requirements (must-have, nice-to-have,",
        "           keywords, minimum experience).",
        "  LLM #2 (gemma2-9b-it) — Evaluates each CV against those requirements",
